                    ...
                    <div class="card <?php if (empty($card['add_crosses_to_list_items']) === false) {
                        ...
                        <div class="info">
                            ...
                            <?php if (empty($card['extra_button']) === false) {
                                echo sprintf('<a href="%s" target="%s" class="btn-ghost">%s</a>', $card['extra_button']['url'], $card['extra_button']['target'], $card['extra_button']['title']);
                            } ?>

                            <?php if (empty($card['author_image']) === false) : ?>
                                <div class="author">
                                    <img src="<?php echo $card['author_image']['sizes']['medium']; ?>"
                                        alt="<?php echo $card['author_image']['alt']; ?>">

                                        <div class="info">
                                            <span class="name"><?php echo $card['author_title']; ?></span>
                                            <span class="role"><?php echo $card['author_role']; ?></span>
                                        </div>
                                </div>
                            <?php endif; ?>
